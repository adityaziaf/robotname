...
public:
    ...
    : Node("FindNearestBall_action_server", options)
  {
    ...
    _ball_sub = this->create_subscription<robotname_msgs::msg::DetectionArray>("/camera1/objects/tracked", 1, std::bind(&FindNearestBallServer::handle_subscription, this,_1));
