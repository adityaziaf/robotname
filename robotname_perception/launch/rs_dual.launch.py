...
local_parameters = [       {'name': 'camera_name1',                  'default': 'camera1', 'description': 'camera unique name'},
                           ...
                           {'name': 'json_file_path2',               'default': [os.path.join(get_package_share_directory('robotname_perception'),'config'),'/realsense2.json'], 'description': 'allows advanced configuration'},
