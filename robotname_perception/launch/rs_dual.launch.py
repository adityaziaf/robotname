...
local_parameters = [       {'name': 'camera_name1',                  'default': 'camera1', 'description': 'camera unique name'},
                           ...
                           {'name': 'accelerate_gpu_with_glsl1',     'default': "true", 'description': 'enable GPU acceleration with GLSL'},
                           ...
                           {'name': 'accelerate_gpu_with_glsl2',     'default': "true", 'description': 'enable GPU acceleration with GLSL'},
                           ...
                           {'name': 'rgb_camera.color_profile2',     'default': '1280,720,5', 'description': 'color stream profile'},
                           ...
                           {'name': 'depth_module.depth_profile2',   'default': '1280,720,5', 'description': 'depth stream profile'},
