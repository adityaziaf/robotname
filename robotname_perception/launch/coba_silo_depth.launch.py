...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera2', 'description': 'camera unique name'},
                           ...
                           {'name': 'serial_no',                    'default': "'234222302035'", 'description': 'choose device by serial number'},
                           ...
                           {'name': 'depth_module.depth_profile',   'default': '480,270,15', 'description': 'depth stream profile'},
